...
const ScrollStack: React.FC<ScrollStackProps> = ({
  ...
  return (
    ...
    >
      <div className={useWindowScroll ? "scroll-stack-inner w-full pb-[40rem]" : "scroll-stack-inner pt-[10vh] md:pt-[20vh] px-4 sm:px-8 md:px-12 lg:px-20 pb-[50rem] min-h-screen"}>
        {children}
